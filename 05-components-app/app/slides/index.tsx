...
import { ImageSourcePropType, FlatList, Image, useWindowDimensions, NativeScrollEvent, NativeSyntheticEvent } from 'react-native';
...
const SlideItem = ({ item }: SlideItemProps) => {
  ...
  return (
    <ThemedView
      className='flex-1 rounded justify-center bg-red-500'

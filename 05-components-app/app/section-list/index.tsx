      ...
      <ThemedCard>
        <SectionList
          ...
          renderSectionHeader={({ section }) => (
            <ThemedText type='h2' className='font-bold mb-2 bg-light-background dark:bg-dark-background'>
              {section.title}
            </ThemedText>
          )}
          ListHeaderComponent={() => (
          ...
          ListFooterComponent={() => (
            <ThemedText type="h1" className='font-bold mb-5 bg-light-background dark:bg-dark-background p-2 rounded'>
